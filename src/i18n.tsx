...
const english = {
  ...
  "settings.resetDataTitle": "Reset all local data",
  "settings.resetDataDescription": "Delete history, models, transcript jobs, saved audio, and downloaded runtimes. External cookies.txt files are not touched.",
  "settings.resetDataConfirm": "Delete all WhisperTube local data? History, models, transcripts, saved audio, and downloaded runtimes will be permanently removed.",
  "settings.resetDataButton": "Delete all local data",
  "settings.resetDataWorking": "Deleting local data…",
  "settings.resetDataComplete": "Local data deleted. The application is ready for a fresh setup.",
  ...
  "settings.resetDataKeepDetail": "The interface language, bundled application files, and files exported outside WhisperTube storage stay untouched.",
...
const messages: Record<UiLanguage, Record<TranslationKey, string>> = {
  ...
  id: {
    ...
    "settings.resetDataTitle": "Reset semua data lokal",
    "settings.resetDataDescription": "Hapus history, model, jobs transkrip, audio tersimpan, dan runtime yang diunduh. File cookies.txt eksternal tidak disentuh.",
    "settings.resetDataConfirm": "Hapus semua data lokal WhisperTube? History, model, transkrip, audio tersimpan, dan runtime yang diunduh akan dihapus permanen.",
    "settings.resetDataButton": "Hapus semua data lokal",
    "settings.resetDataWorking": "Menghapus data lokal…",
    "settings.resetDataComplete": "Data lokal dihapus. Aplikasi siap untuk setup baru.",
    ...
    "settings.resetDataKeepDetail": "Bahasa UI, file aplikasi bawaan, dan file hasil export di luar storage WhisperTube tetap aman.",
  ...
  zh: {
    ...
    "settings.resetDataTitle": "重置所有本地数据",
    "settings.resetDataDescription": "删除历史记录、模型、转录任务、保存的音频和已下载的运行环境。不删除外部 cookies.txt 文件。",
    "settings.resetDataConfirm": "删除所有 WhisperTube 本地数据？历史记录、模型、转录文本、保存的音频和运行环境将永久删除。",
    "settings.resetDataButton": "删除所有本地数据",
    "settings.resetDataWorking": "正在删除本地数据…",
    "settings.resetDataComplete": "本地数据已删除。应用可以重新设置。",
    ...
    "settings.resetDataKeepDetail": "界面语言、应用自带文件以及 WhisperTube 存储之外导出的文件不会受到影响。",
