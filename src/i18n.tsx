...
const english = {
  ...
  "source.memberHint": "For login-protected videos, import cookies.txt in Settings.",
...
const messages: Record<UiLanguage, Record<TranslationKey, string>> = {
  ...
  id: {
    ...
    "source.memberHint": "Untuk video yang memerlukan login, import cookies.txt di Pengaturan.",
  ...
  zh: {
    ...
    "source.memberHint": "对于需要登录的视频，请在设置中导入 cookies.txt。",
    "source.access": "浏览器访问",
