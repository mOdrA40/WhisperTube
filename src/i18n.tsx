...
const english = {
  ...
  "controls.installCuda": "Install CUDA acceleration (~437 MB)",
  ...
  "settings.cudaInfo": "The CUDA engine is downloaded from an official whisper.cpp release and stored in app storage (~437 MB).",
...
const messages: Record<UiLanguage, Record<TranslationKey, string>> = {
  ...
  id: {
    ...
    "controls.installCuda": "Pasang akselerasi CUDA (~437 MB)",
    ...
    "settings.cudaInfo": "Engine CUDA diunduh dari release resmi whisper.cpp dan disimpan di storage aplikasi (~437 MB).",
  ...
  zh: {
    ...
    "controls.installCuda": "安装 CUDA 加速（约 437 MB）",
    ...
    "settings.cudaInfo": "CUDA 引擎来自官方 whisper.cpp release，并安装到应用存储中（约 437 MB）。",
