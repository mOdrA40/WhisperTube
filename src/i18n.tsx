...
const english = {
  ...
  "error.sourceInputInvalid": "This is not a valid supported video link. Paste a complete http/https video URL.",
  "error.sourceDuration": "Live streams, upcoming streams, media with unknown duration, and videos longer than 8 hours are not supported.",
...
const messages: Record<UiLanguage, Record<TranslationKey, string>> = {
  ...
  "error.sourceAccessRequired": "Video ini memerlukan session login. Import cookies.txt dari akun yang bisa memutarnya, lalu coba lagi.",
    ...
    "error.sourceInputInvalid": "Link video ini tidak valid atau belum didukung. Tempel URL video http/https yang lengkap.",
    "error.sourceDuration": "Live stream, siaran mendatang, media tanpa durasi pasti, dan video lebih dari 8 jam belum didukung.",
  ...
  "error.sourceAccessRequired": "此视频需要登录会话。请导入能够播放该视频账号的 cookies.txt，然后重试。",
    ...
    "error.sourceInputInvalid": "此视频链接无效或尚不受支持。请粘贴完整的 http/https 视频 URL。",
    "error.sourceDuration": "暂不支持直播、即将开始的直播、时长未知的媒体以及超过 8 小时的视频。",
